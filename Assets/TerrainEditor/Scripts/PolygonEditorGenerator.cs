...
[System.Serializable]
public class PolygonEditorGenerator : MonoBehaviour {
	
	public static PolygonEditorGenerator porigon; 
	public List<PolygonEditorGenerator> savedTerrains = new List<PolygonEditorGenerator>();
	...
	public int  SizeX = 20; //default: 96
	public int SizeY = 20;
	...
	void GenTerrain20(byte[,] blocks, int x, int y){
