...
public class MonsterEditorPooler : MonoBehaviour {
	
	public GameObject Player;
	public GameObject Terrain;
	private PolygonEditorGenerator tscript;
	private NewObjectPoolerScript poola;
	private int size = 7;
	
	// Use this for initialization
	void Start () {
		tscript = Terrain.GetComponent("PolygonEditorGenerator") as PolygonEditorGenerator;
